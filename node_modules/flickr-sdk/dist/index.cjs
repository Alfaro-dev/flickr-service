...
__reExport(querystring_exports, require("node:querystring"));
...
function hmac(text, key) {
  return (0, import_node_crypto.createHmac)("sha1", key).update(text).digest("base64");
}
function join(arr) {
...
var OAuth = class {
   ...
   */
  nonce() {
    return (0, import_node_crypto.randomBytes)(32).toString("base64");
  }
  /**
...
__reExport(fs_promises_exports, require("node:fs/promises"));
...
// src/shims/url.ts
var url_exports = {};
__reExport(url_exports, require("node:url"));
